...
## 1. File
Exact source path: [`apps/booth-app/components/ui/select.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/select.tsx)
...
## 3. Purpose
Complex multi-level dropdown select primitive (272 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `select` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (272 lines of unused code).
...
Prune in favor of full-screen list picker or bottom sheet.
...
- **Reason**: Prune in favor of full-screen list picker or bottom sheet.
