...
## 1. File
Exact source path: [`apps/booth-app/components/ui/tabs.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/tabs.tsx)
...
## 3. Purpose
Tabbed container switcher using @rn-primitives/tabs.

## 4. Responsibilities
- Provide a reusable, theme-aware `tabs` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (76 lines of unused code).
...
Adopt in cashier home screen to switch between departure times / routes.
...
- **Decision**: `KEEP`
- **Reason**: Adopt in cashier home screen to switch between departure times / routes.
