...
## 1. File
Exact source path: [`apps/booth-app/components/ui/popover.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/popover.tsx)
...
## 3. Purpose
Anchored floating popover using @rn-primitives/popover.

## 4. Responsibilities
- Provide a reusable, theme-aware `popover` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (64 lines of unused code).
...
Prune in favor of native dialogs/sheets.
...
- **Reason**: Prune in favor of native dialogs/sheets.
