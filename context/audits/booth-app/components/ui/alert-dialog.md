...
## 1. File
Exact source path: [`apps/booth-app/components/ui/alert-dialog.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/alert-dialog.tsx)
...
## 3. Purpose
Modal confirmation alert dialog using @rn-primitives/alert-dialog for destructive operations.

## 4. Responsibilities
- Provide a reusable, theme-aware `alert-dialog` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (169 lines of unused code).
...
Retain for shift close and booking cancellation confirmation dialogs.
...
- **Decision**: `KEEP`
- **Reason**: Retain for shift close and booking cancellation confirmation dialogs.
