...
## 1. File
Exact source path: [`apps/booth-app/components/ui/label.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/label.tsx)
...
## 3. Purpose
Form input label wrapper using @rn-primitives/label.

## 4. Responsibilities
- Provide a reusable, theme-aware `label` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (42 lines of unused code).
...
Adopt for standardized form headers.
...
- **Decision**: `KEEP`
- **Reason**: Adopt for standardized form headers.
