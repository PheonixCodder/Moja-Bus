...
## 1. File
Exact source path: [`apps/booth-app/components/ui/progress.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/progress.tsx)
...
## 3. Purpose
Horizontal progress bar primitive using @rn-primitives/progress.

## 4. Responsibilities
- Provide a reusable, theme-aware `progress` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (93 lines of unused code).
...
Adopt for queue sync progress and bus seat occupancy ratio bars.
...
- **Decision**: `KEEP`
- **Reason**: Adopt for queue sync progress and bus seat occupancy ratio bars.
