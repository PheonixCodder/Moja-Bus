...
## 1. File
Exact source path: [`apps/booth-app/components/ui/checkbox.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/checkbox.tsx)
...
## 3. Purpose
Square checkbox control using @rn-primitives/checkbox.

## 4. Responsibilities
- Provide a reusable, theme-aware `checkbox` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (53 lines of unused code).
...
Retain for passenger intake (walk-up account creation checkbox).
...
- **Decision**: `KEEP`
- **Reason**: Retain for passenger intake (walk-up account creation checkbox).
