...
## 1. File
Exact source path: [`apps/booth-app/components/ui/collapsible.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/collapsible.tsx)
...
## 3. Purpose
Minimal 10-line wrapper for @rn-primitives/collapsible.

## 4. Responsibilities
- Provide a reusable, theme-aware `collapsible` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (10 lines of unused code).
...
Consolidate with accordion or prune.
...
- **Reason**: Consolidate with accordion or prune.
