...
## 1. File
Exact source path: [`apps/booth-app/components/ui/separator.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/separator.tsx)
...
## 3. Purpose
Lightweight divider line primitive wrapping @rn-primitives/separator.

## 4. Responsibilities
- Provide a reusable, theme-aware `separator` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (25 lines of unused code).
...
Retain for structured card dividers.
...
- **Decision**: `KEEP`
- **Reason**: Retain for structured card dividers.
