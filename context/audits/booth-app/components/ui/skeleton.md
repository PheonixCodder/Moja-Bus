...
## 1. File
Exact source path: [`apps/booth-app/components/ui/skeleton.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/skeleton.tsx)
...
## 3. Purpose
Pulsing placeholder box primitive for loading states.

## 4. Responsibilities
- Provide a reusable, theme-aware `skeleton` UI primitive for the Booth application.
...
1. **Is it used?**: Yes.
2. **Where is it used?**: app/(tabs)/bookings.tsx, app/(tabs)/index.tsx, app/reconcile.tsx, app/terminal-select.tsx.
...
Keep for all loading list placeholders.
...
- **Decision**: `KEEP`
- **Reason**: Keep for all loading list placeholders.
