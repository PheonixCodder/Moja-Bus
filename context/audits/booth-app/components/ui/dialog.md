...
## 1. File
Exact source path: [`apps/booth-app/components/ui/dialog.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/dialog.tsx)
...
## 3. Purpose
General modal popup dialog using @rn-primitives/dialog.

## 4. Responsibilities
- Provide a reusable, theme-aware `dialog` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (180 lines of unused code).
...
Retain for modal ticket preview and terminal switch modals.
...
- **Decision**: `KEEP`
- **Reason**: Retain for modal ticket preview and terminal switch modals.
