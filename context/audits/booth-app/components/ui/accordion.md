...
## 1. File
Exact source path: [`apps/booth-app/components/ui/accordion.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/accordion.tsx)
...
## 3. Purpose
Expandable accordion container using @rn-primitives/accordion.

## 4. Responsibilities
- Provide a reusable, theme-aware `accordion` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (157 lines of unused code).
...
Unused in booth cashier flows; prune during refactoring if no collapsible schedules needed.
...
- **Reason**: Unused in booth cashier flows; prune during refactoring if no collapsible schedules needed.
