...
## 1. File
Exact source path: [`apps/booth-app/components/ui/textarea.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/textarea.tsx)
...
## 4. Responsibilities
- Provide a reusable, theme-aware `textarea` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (31 lines of unused code).
...
Adopt in reconcile screen for operator shift notes.
...
- **Decision**: `KEEP`
- **Reason**: Adopt in reconcile screen for operator shift notes.
