...
## 1. File
Exact source path: [`apps/booth-app/components/ui/toggle.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/toggle.tsx)
...
## 3. Purpose
Two-state button toggle primitive.

## 4. Responsibilities
- Provide a reusable, theme-aware `toggle` UI primitive for the Booth application.
...
- **Reason**: Consolidate with button.
