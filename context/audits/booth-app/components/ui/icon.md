...
## 1. File
Exact source path: [`apps/booth-app/components/ui/icon.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/icon.tsx)
...
## 3. Purpose
Icon wrapper binding Lucide / Lucide-React-Native.

## 4. Responsibilities
- Provide a reusable, theme-aware `icon` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (40 lines of unused code).
...
Monorepo standard uses Hugeicons (@hugeicons/react-native). Consolidate or prune.
...
- **Reason**: Monorepo standard uses Hugeicons (@hugeicons/react-native). Consolidate or prune.
