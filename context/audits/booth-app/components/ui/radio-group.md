...
## 1. File
Exact source path: [`apps/booth-app/components/ui/radio-group.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/radio-group.tsx)
...
## 3. Purpose
Single-choice radio button group using @rn-primitives/radio-group.

## 4. Responsibilities
- Provide a reusable, theme-aware `radio-group` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (36 lines of unused code).
...
Adopt in payment screen for tender selection (Cash vs Paystack).
...
- **Decision**: `KEEP`
- **Reason**: Adopt in payment screen for tender selection (Cash vs Paystack).
