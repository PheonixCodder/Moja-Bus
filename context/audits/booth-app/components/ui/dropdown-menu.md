...
## 1. File
Exact source path: [`apps/booth-app/components/ui/dropdown-menu.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/dropdown-menu.tsx)
...
## 3. Purpose
Desktop dropdown menu primitive (331 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `dropdown-menu` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (331 lines of unused code).
...
Prune; mobile apps use bottom sheets or native dialogs.
...
- **Decision**: `REMOVE`
- **Reason**: Prune; mobile apps use bottom sheets or native dialogs.
