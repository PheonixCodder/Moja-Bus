...
## 1. File
Exact source path: [`apps/booth-app/components/ui/context-menu.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/context-menu.tsx)
...
## 3. Purpose
Desktop right-click context menu (324 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `context-menu` UI primitive for the Booth application.
...
13. **Should it be removed?**: Yes, in cleanup phase.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (324 lines of unused code).
...
Prune; desktop right-click menu is inappropriate for mobile touch POS.
...
- **Decision**: `REMOVE`
- **Reason**: Prune; desktop right-click menu is inappropriate for mobile touch POS.
