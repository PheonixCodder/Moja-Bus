...
## 1. File
Exact source path: [`apps/booth-app/components/ui/menubar.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/menubar.tsx)
...
## 3. Purpose
Desktop application menubar (381 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `menubar` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (381 lines of unused code).
...
Prune; completely dead code with zero applicability to handheld POS.
...
- **Decision**: `REMOVE`
- **Reason**: Prune; completely dead code with zero applicability to handheld POS.
