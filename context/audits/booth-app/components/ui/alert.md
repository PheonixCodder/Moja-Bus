...
## 1. File
Exact source path: [`apps/booth-app/components/ui/alert.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/alert.tsx)
...
## 3. Purpose
Callout banner primitive with icon and text for warning or error notices.

## 4. Responsibilities
- Provide a reusable, theme-aware `alert` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (86 lines of unused code).
...
Adopt in reconcile screen for cash discrepancy warnings.
...
- **Decision**: `KEEP`
- **Reason**: Adopt in reconcile screen for cash discrepancy warnings.
