...
## 1. File
Exact source path: [`apps/booth-app/components/ui/tooltip.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/tooltip.tsx)
...
## 3. Purpose
Floating tooltip on long press (81 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `tooltip` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (81 lines of unused code).
...
Prune; touch POS operators do not rely on hover tooltips.
...
- **Decision**: `REMOVE`
- **Reason**: Prune; touch POS operators do not rely on hover tooltips.
