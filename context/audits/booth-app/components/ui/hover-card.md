...
## 1. File
Exact source path: [`apps/booth-app/components/ui/hover-card.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/hover-card.tsx)
...
## 3. Purpose
Desktop mouse hover preview card (61 lines).

## 4. Responsibilities
- Provide a reusable, theme-aware `hover-card` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (61 lines of unused code).
...
Prune; touchscreens have no hover state.
...
- **Decision**: `REMOVE`
- **Reason**: Prune; touchscreens have no hover state.
