...
## 1. File
Exact source path: [`apps/booth-app/components/ui/switch.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/switch.tsx)
...
## 3. Purpose
Binary toggle switch using @rn-primitives/switch.

## 4. Responsibilities
- Provide a reusable, theme-aware `switch` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (38 lines of unused code).
...
Adopt in profile screen for printer auto-print toggle.
...
- **Decision**: `KEEP`
- **Reason**: Adopt in profile screen for printer auto-print toggle.
