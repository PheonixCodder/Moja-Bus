...
## 1. File
Exact source path: [`apps/booth-app/components/ui/native-only-animated-view.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/native-only-animated-view.tsx)
...
## 3. Purpose
Platform-specific Reanimated wrapper used by modal and dropdown animations.

## 4. Responsibilities
- Provide a reusable, theme-aware `native-only-animated-view` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (33 lines of unused code).
...
Retain as internal animation helper for dialogs.
...
- **Decision**: `KEEP`
- **Reason**: Retain as internal animation helper for dialogs.
