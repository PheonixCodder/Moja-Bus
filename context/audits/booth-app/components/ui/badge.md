...
## 1. File
Exact source path: [`apps/booth-app/components/ui/badge.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/badge.tsx)
...
## 3. Purpose
Status badge and pill primitive with dedicated booth domain variants (intercity, urban, cash, offline).

## 4. Responsibilities
- Provide a reusable, theme-aware `badge` UI primitive for the Booth application.
...
1. **Is it used?**: Yes.
2. **Where is it used?**: app/(tabs)/bookings.tsx, app/(tabs)/index.tsx, app/(tabs)/profile.tsx, app/reconcile.tsx, app/sell/confirmation.tsx, app/sell/passenger.tsx, app/sell/payment.tsx, app/sell/[tripId].tsx.
...
Keep as canonical pill/badge component.
...
- **Decision**: `KEEP`
- **Reason**: Keep as canonical pill/badge component.
