...
## 1. File
Exact source path: [`apps/booth-app/components/ui/aspect-ratio.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/aspect-ratio.tsx)
...
## 3. Purpose
Minimal 6-line wrapper for @rn-primitives/aspect-ratio.

## 4. Responsibilities
- Provide a reusable, theme-aware `aspect-ratio` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (6 lines of unused code).
...
Unused in mobile POS; prune during cleanup.
...
- **Decision**: `REMOVE`
- **Reason**: Unused in mobile POS; prune during cleanup.
