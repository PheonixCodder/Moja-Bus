...
## 1. File
Exact source path: [`apps/booth-app/components/ui/avatar.tsx`](file:///C:/dev/moja-buss/apps/booth-app/components/ui/avatar.tsx)
...
## 3. Purpose
Avatar image and fallback initials circle using @rn-primitives/avatar.

## 4. Responsibilities
- Provide a reusable, theme-aware `avatar` UI primitive for the Booth application.
...
## 21. Problems
1. [DEAD CODE] 0 active consumers in apps/booth-app (137 lines of unused code).
...
Adopt in profile screen for cashier profile avatar.
...
- **Decision**: `KEEP`
- **Reason**: Adopt in profile screen for cashier profile avatar.
