...
**Last completed:** Aggregator-web dashboard shell and auth copy mirrored from demo-ui into Moja Bus content
...
- [x] Aggregator web auth views rewritten with Moja Bus content and Google social login
...
- Teal and gold are temporary brand placeholders
...
- `apps/aggregator-web` now has a Moja Bus dashboard shell under `/dashboard` plus nested `/dashboard/search`, `/dashboard/bookings`, `/dashboard/tickets`, and `/dashboard/settings`
- `apps/aggregator-web` auth views now use Moja Bus copy and the shared Google social login component
