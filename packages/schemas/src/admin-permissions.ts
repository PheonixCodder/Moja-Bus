...
export const ADMIN_STAFF_STATUSES = [
  "ACTIVE",
  "INACTIVE",
  "SUSPENDED",
] as const;
...
export const ADMIN_PERMISSION_META = {
  ...
  "companies:suspend": {
    group: "Companies",
    label: "Suspend/Activate companies",
  },

  // Operator Staff (cross-company)
  "operator-staff:read": {
    group: "Operator Staff",
    label: "View operator staff",
  },
  "operator-staff:update": {
    group: "Operator Staff",
    label: "Edit operator staff",
  },
  "operator-staff:remove": {
    group: "Operator Staff",
    label: "Remove operator staff",
  },

  // Financials (Platform)
  "platform:financials:read": {
    group: "Financials",
    label: "View platform financials",
  },
  ...
  "platform:schedules:manage": {
    group: "Operations",
    label: "Manage schedules",
  },
  "platform:fleet:read": { group: "Operations", label: "View all fleet" },
  "platform:terminals:read": {
    group: "Operations",
    label: "View all terminals",
  },
  ...
  "verifications:decide": {
    group: "Verifications",
    label: "Approve/Reject verifications",
  },
  "verifications:manage": {
    group: "Verifications",
    label: "Manage verification checklist",
  },

  // Driver Marketplace (Phase 14)
  "marketplace:read": {
    group: "Verifications",
    label: "View driver marketplace health & offers",
  },
  "marketplace:manage": {
    group: "Verifications",
    label: "Feature/suspend drivers in the marketplace",
  },
  // Phase 25 (F-OP-09) — platform driver verification governance. Seeded into
  // the ADMIN role template (no deploy cliff for template-backed staff);
  // staff with explicit grant-lists need the keys granted individually, and
  // custom roles simply omit them.
  "drivers:verify.read": {
    group: "Verifications",
    label: "View driver verification hub",
  },
  "drivers:verify.manage": {
    group: "Verifications",
    label: "Approve/reject/suspend driver licenses",
  },

  // Audit & Security
  "audit:read": { group: "Audit & Security", label: "View activity logs" },
  "audit:bank-access:read": {
    group: "Audit & Security",
    label: "View bank access logs",
  },
  "audit:webhooks:read": {
    group: "Audit & Security",
  ...
  "marketing:credits:issue": {
    group: "Marketing",
    label: "Issue promo credits",
  },
  ...
  "platform:settings:update": {
    group: "Settings",
    label: "Update platform settings",
  },
  "platform:settings:audit": {
    group: "Settings",
    label: "View settings audit log",
  },
  ...
  "admin-staff:update": {
    group: "Admin Staff",
    label: "Update admin staff roles/permissions",
  },
  "admin-staff:remove": { group: "Admin Staff", label: "Remove admin staff" },
  "admin-staff:transfer": {
    group: "Admin Staff",
    label: "Transfer admin ownership",
  },
 ...
 */
export const ADMIN_ROLE_TEMPLATES: Record<
  AdminStaffRole,
  AdminPermissionKey[]
> = {
  SUPER_ADMIN: [],
  ...
  ADMIN: [
    ...
    "verifications:decide",
    "verifications:manage",
    // Phase 25 (F-OP-09) — seeded into the ADMIN template so existing admins
    // keep the hub they already had (no deploy-time access cliff). Staff with
    // explicit grant-lists still need the keys granted individually; custom
    // roles simply omit them.
    "drivers:verify.read",
    "drivers:verify.manage",
    "marketplace:read",
    "marketplace:manage",
...
export function getAdminTemplatePermissions(
  role: AdminStaffRole,
): AdminPermissionKey[] {
