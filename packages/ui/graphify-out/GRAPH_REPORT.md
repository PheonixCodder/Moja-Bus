...
## Corpus Check
- 71 files · ~16,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 585 nodes · 702 edges · 44 communities (36 shown, 8 thin omitted)
...
Cohesion: 0.05
Nodes (39): @base-ui/react, class-variance-authority, cmdk, cn, date-fns, embla-carousel-react, input-otp, libphonenumber-js (+31 more)
