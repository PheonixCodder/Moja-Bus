			...
			>
				...
				<View className="bg-white rounded-[20px] border border-slate-100 p-4 gap-3 shadow-sm shadow-black/5">
					<View className="flex-row items-center gap-3">
						...
						<View className="flex-1">
							<Text className="text-base font-bold text-slate-900">{t("accountSecurity")}</Text>
							<Text className="text-sm text-slate-500 mt-0.5">{t("encryptionDesc")}</Text>
						</View>
					</View>
					...
					<View className="gap-3">
						<View className="flex-row items-center justify-between">
							<View className="flex-row items-center gap-2">
								...
								<Text className="text-sm font-medium text-slate-800">{t("emailVerification")}</Text>
							</View>
						...
						<View className="flex-row items-center justify-between">
							<View className="flex-row items-center gap-2">
								...
								<Text className="text-sm font-medium text-slate-800">{t("twoFactorAuth")}</Text>
							</View>
							<View className="bg-pink-50 px-2.5 py-1 rounded-xl">
								<Text className="text-xs font-semibold text-pink-600">{t("emailVerified")}</Text>
							</View>
						</View>
					</View>
				</View>
				...
				<View className="bg-white rounded-[20px] border border-slate-100 p-4 gap-3 shadow-sm shadow-black/5">
					...
					<View className="flex-row items-center gap-3 py-2">
						...
						<View className="flex-1">
							<View className="flex-row items-center gap-1.5">
								<Text className="text-sm font-semibold text-slate-800">{t("travelerMobileApp")}</Text>
								<View className="bg-emerald-500/10 px-1.5 py-0.5 rounded">
									<Text className="text-xs font-bold text-emerald-600">{t("currentDevice")}</Text>
								</View>
							</View>
							<Text className="text-xs text-slate-500 mt-0.5">{t("activeSession")}</Text>
						</View>
					</View>
					...
					<View className="flex-row items-center gap-3 py-2">
						...
						<View className="flex-1">
							<Text className="text-sm font-medium text-slate-800">{t("webBrowserSession")}</Text>
							<Text className="text-xs text-slate-500 mt-0.5">{t("mojaWebPortal")}</Text>
						</View>
					</View>
				</View>
