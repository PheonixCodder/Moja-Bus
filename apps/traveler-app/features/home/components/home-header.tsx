	...
	return (
		<View className="flex-row items-center justify-between py-1">
			<View className="flex-1 pr-3 gap-0.5">
				<Text className="will-change-variable text-sm font-semibold text-muted-foreground uppercase tracking-widest">
					{t("greeting", "Hello")}
				</Text>
				<Text
					className="will-change-variable text-2xl font-black text-foreground tracking-tight"
					numberOfLines={1}
				>
					{userName}
				</Text>
			...
			<View className="flex-row items-center gap-2">
				<Pressable
					...
					className="will-change-pressable flex-row items-center gap-1.5 bg-primary/10 border border-primary/20 px-3 py-2 rounded-full active:bg-primary/20"
				>
					<HugeiconsIcon icon={Wallet01Icon} size={15} color={Palette.rose[500]} />
					<Text className="will-change-variable text-xs font-extrabold text-primary">
