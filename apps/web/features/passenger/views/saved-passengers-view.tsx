      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:max-w-xs">
          ...
          <Input
            ...
            className="pl-9 h-10 rounded-xl border-border text-sm focus-visible:ring-primary"
          />
        </div>

        <Button
          onClick={openCreate}
          className="bg-primary hover:bg-primary/95 text-primary-foreground font-bold h-10 rounded-xl shadow-sm w-full sm:w-auto"
        >
        ...
        <CardContent className="p-0">
          {filteredPassengers.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center space-y-3">
              <div className="w-12 h-12 bg-muted rounded-full flex items-center justify-center text-muted-foreground border border-border">
              ...
              <Table>
                <TableHeader className="bg-muted">
                  <TableRow className="border-b border-border/80 hover:bg-transparent">
                    ...
                    <TableHead className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider h-11 px-6 text-right">
                      {t("colActions")}
                    </TableHead>
                  </TableRow>
                </TableHeader>
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4">
                        {passenger.label ? (
                          <Badge
                            variant="secondary"
                            className="bg-muted text-foreground border border-border text-[10px] font-extrabold py-0.5 px-2 rounded-md gap-1"
                          >
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {!passenger.isSelf && (
                            <Button
                              ...
                              variant="outline"
                              size="sm"
                              className="h-8 text-xs font-semibold rounded-lg border-border text-destructive hover:text-destructive hover:bg-destructive/10"
