const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  OAuthCallbackError:
    "OAuth sign-in failed. Please try again or use a different sign-in method.",
  OAuthCreateAccount:
    "Could not create account with this sign-in method. Please try a different method.",
  ...
  // Verification errors
  VerificationFailed:
    "Email verification failed. Please request a new verification code.",
  VerificationExpired:
  ...
  WorkEmailAlreadyExists:
    "This work email is already registered. Please use a different business email.",
