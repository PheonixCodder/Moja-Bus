...
export function ResetPasswordView({ email, userType = "passenger" }: ResetPasswordViewProps) {
    ...
    <div className="flex w-full flex-col items-center gap-8">
      ...
      <p className="text-xs text-muted-foreground">
        Didn't receive a code? {
          <Link href={isPassenger ? "/forgot-password" : "/operator/forgot-password"} className="font-medium text-primary hover:underline">
            Resend code
          </Link>
        }
      </p>
