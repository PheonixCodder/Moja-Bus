...
export async function HomeCta() {
  ...
  return (
    <section className="py-32 px-6 md:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto rounded-[3rem] bg-gradient-to-br from-primary to-primary/95 text-foreground relative overflow-hidden flex flex-col lg:flex-row items-stretch min-h-[600px] shadow-2xl border border-border">
        ...
        <div className="bg-card p-10 md:p-20 lg:w-[55%] lg:rounded-r-[6rem] lg:rounded-l-[3rem] rounded-[3rem] relative z-10 flex flex-col justify-center items-start border-r border-border/50">
          {/* Badge */}
          <div className="flex items-center gap-2 px-3.5 py-1.5 bg-success/10 text-success rounded-full text-xs font-bold border border-success/30 shadow-sm mb-6 select-none">
          ...
          <div className="flex flex-wrap gap-4 w-full sm:w-auto">
            ...
            <a
              href="#"
              className="flex items-center gap-3 bg-foreground hover:bg-foreground/90 text-background px-5 py-3.5 rounded-xl transition-all shadow-md active:scale-95 shrink-0"
            >
