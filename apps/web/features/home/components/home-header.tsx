                ...
                <Popover>
                  <PopoverTrigger className="flex items-center gap-2 outline-none cursor-pointer ml-2">
                    <Avatar
                      className={cn(
                        ...
                        hasLightText ? "border-white/30" : "border-slate-100",
                      )}
                    >
                      <AvatarImage
                        src={user.image || ""}
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <Link
                        href="/dashboard"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-50 text-slate-700 transition-colors"
                      >
