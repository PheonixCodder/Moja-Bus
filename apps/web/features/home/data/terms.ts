          ...
          lists: [
            {
              ...
              items: [
                ...
                "During promotional campaigns, voucher use may be further limited per person. A traveler may hold at most the published number of active promotional vouchers (marketing, goodwill, admin grant, referral welcome), as configured by Moja Ride and shown in the wallet. Cancellation and modification-difference vouchers do not count toward that limit. Moja Ride may cancel bookings that exceed published campaign limits.",
