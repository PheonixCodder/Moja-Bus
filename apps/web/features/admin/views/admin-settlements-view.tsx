        ...
        <Card className="bg-white border-border shadow-sm p-4">
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Filter by Operator:</span>
              <select
          ...
          <div className="rounded-md border border-dashed border-slate-200 bg-slate-50/50 p-12 text-center space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
                There are no credits or debits recorded in the transaction ledger yet.
              </p>
            </div>
          </div>
        ) : ledgerResult ? (
          ...
          <DialogContent className="max-w-md border border-border bg-white rounded-lg p-6">
            <DialogHeader>
              ...
              <DialogDescription className="text-xs text-slate-500">
                Submit a bank transfer settlement for {payoutCompany.name} and log it in their transaction ledger.
              </DialogDescription>
            </DialogHeader>
              ...
              <form onSubmit={handleRecordPayout} className="space-y-4 py-2">
                <div className="rounded border border-slate-100 p-3 bg-slate-50 space-y-1 text-xs text-slate-600">
                  ...
                  <div className="flex justify-between pt-1.5 border-t border-slate-200 mt-1">
                    ...
                    <span className="font-bold text-slate-900">{exportData.balanceXOF.toLocaleString()} XOF</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="text"
                    placeholder="e.g. Bank transfer reference #10023055"
                    value={payoutNote}
