...
import {
  ...
  PageHeaderActions,
  PageHeaderControls,
} from "@/features/operator/components/header";
...
export function ScheduleToolbar({
  ...
  return (
    <div className="px-5 py-3 border-b border-border shrink-0">
      <PageHeader className="flex-col sm:flex-row gap-3 pb-0">
        <PageHeaderControls className="flex-1 min-w-0 flex-wrap gap-3">
