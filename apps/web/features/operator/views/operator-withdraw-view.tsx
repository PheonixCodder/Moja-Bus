...
export function OperatorWithdrawView() {
  ...
  const availableBalance = snapshot.liveAvailableBalance;
  const postedBalance = snapshot.livePostedBalance;
  const escrowBalance = postedBalance - availableBalance;
  ...
  const handleWithdraw = () => {
    ...
    withdrawMutation.mutate({ amountXOF: parsedAmount });
  };
      ...
      <Card>
        ...
        <CardContent className="space-y-4 max-w-md">
          ...
          <Button
            ...
            disabled={withdrawMutation.isPending || availableBalance <= 0 || !amountXOF}
          >
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-1 text-sm text-amber-800">
                ...
                <ul className="list-disc pl-4 space-y-1 text-amber-700/90 text-xs">
                  ...
                  <li>You may only withdraw once every 24 hours.</li>
                  <li>
                ...
                <Table>
                  ...
                  <TableBody>
                    {withdrawals.items.map((tx) => {
                      ...
                      const grossAmount = Number(tx.entries[0]?.amount || 0);
