const fs = require("fs");
const content = fs.readFileSync("features/search/components/search-results.tsx", "utf8");
...
const offerCard = fs.readFileSync("features/search/components/offer-card.tsx", "utf8");
