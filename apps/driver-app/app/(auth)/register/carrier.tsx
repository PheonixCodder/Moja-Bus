									...
									<View className="flex-row items-center justify-between w-full">
										...
										<View className="flex-row items-center gap-2">
											<View className="bg-border px-2 py-0.5 rounded">
												<Text className="text-xs font-bold text-muted-foreground">{t(item.badgeKey)}</Text>
											</View>
											{isSelected ? (
				...
				<Card className="p-5 gap-3">
					<View className="flex-row items-center justify-between">
						...
						<View className="bg-muted-foreground/20 px-2.5 py-1 rounded-full">
							<Text className="text-xs font-bold text-muted-foreground uppercase">{t("carrierCodeOptional")}</Text>
						</View>
					</View>
					<Text className="text-xs text-muted-foreground leading-5">
