  ...
  "shrink-0 flex-row items-center justify-center gap-1.5 overflow-hidden rounded-full border px-2.5 py-0.5",
  {
    variants: {
      variant: {
        ...
        intercity: "bg-muted/60 border-border/70",
        urban: "bg-muted/40 border-border/60",
        cash: "bg-muted/50 border-border/60",
        offline: "bg-amber-100/80 border-amber-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
const badgeTextVariants = cva("text-xs font-semibold tracking-tight", {
  variants: {
    variant: {
      ...
      intercity: "text-foreground font-bold",
      urban: "text-muted-foreground font-bold",
      cash: "text-foreground font-bold",
